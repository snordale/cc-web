...
import { useLoginMutation, useMeQuery, useSendPasswordResetMutation } from '../src/generated/graphql'
			...
			<Formik
				...
				onSubmit={async (data, { setErrors }) => {
					...
					if (errors) {
						...
						toast.success(`Welcome ${res.data?.login.user?.username}`, { id: "welcome" })
