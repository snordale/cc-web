...
export type ErrorsFragFragment = {
	__typename?: "FieldError";
	field: string;
	message: string;
};

export type PrivateUserFragment = {
	__typename?: "User";
	id: number;
	createdAt: string;
	updatedAt: string;
...
export type GetBasicAuthLinkMutation = {
	__typename?: "Mutation";
	getBasicAuthLink: string;
};

export type GetCuratorAuthLinkMutationVariables = Exact<{
	[key: string]: never;
}>;

export type GetCuratorAuthLinkMutation = {
	__typename?: "Mutation";
	getCuratorAuthLink: string;
};

export type GetNewCuratorTokenMutationVariables = Exact<{
	[key: string]: never;
}>;

export type GetNewCuratorTokenMutation = {
	__typename?: "Mutation";
	getNewCuratorToken?: string | null;
};
...
export type GetUsersTopTracksQuery = {
	__typename?: "Query";
	getUsersTopTracks: {
		__typename?: "PublicSpotify";
		tracks: Array<{
...
export function useGetBasicAuthLinkMutation() {
	return Urql.useMutation<
		GetBasicAuthLinkMutation,
		GetBasicAuthLinkMutationVariables
	>(GetBasicAuthLinkDocument);
}
...
export function useGetCuratorAuthLinkMutation() {
	return Urql.useMutation<
		GetCuratorAuthLinkMutation,
		GetCuratorAuthLinkMutationVariables
	>(GetCuratorAuthLinkDocument);
}
...
export function useGetNewCuratorTokenMutation() {
	return Urql.useMutation<
		GetNewCuratorTokenMutation,
		GetNewCuratorTokenMutationVariables
	>(GetNewCuratorTokenDocument);
}
export const LoginDocument = gql`
	mutation login($emailOrUsername: String!, $password: String!) {
		login(
			data: { emailOrUsername: $emailOrUsername, passwordHash: $password }
		) {
			user {
				...PrivateUser
			}
...
export function useSetPasswordMutation() {
	return Urql.useMutation<SetPasswordMutation, SetPasswordMutationVariables>(
		SetPasswordDocument
	);
}
...
export function useGetUsersTopTracksQuery(
	options: Omit<Urql.UseQueryArgs<GetUsersTopTracksQueryVariables>, "query">
) {
	return Urql.useQuery<
		GetUsersTopTracksQuery,
		GetUsersTopTracksQueryVariables
	>({ query: GetUsersTopTracksDocument, ...options });
}
...
export function useSongsQuery(
	options?: Omit<Urql.UseQueryArgs<SongsQueryVariables>, "query">
) {
	return Urql.useQuery<SongsQuery, SongsQueryVariables>({
		query: SongsDocument,
		...options,
	});
}
